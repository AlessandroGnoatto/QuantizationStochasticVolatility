...
public class HestonModel implements ModelInterface {
	...
	public HestonModel(double r, double k, double theta, double sigma, double rho) {
	...
	public HestonModel(HestonParameterFunction parameters) {
