...
public class SABRModel implements ModelInterface{
	...
	public SABRModel(double alpha, double beta, double rho) {

		this.parameters = new SABRParameterFunction(alpha,beta,rho);
	}

	public SABRModel(ParameterFunctionInterface parameters) {
