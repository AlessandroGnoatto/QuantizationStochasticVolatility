...
public class Model32 extends AbstractModel{
	...
	public Model32(double r, double omega, double theta, double sigma, double rho) {
		this.riskFree = r;
		this.parameters = new AlphaHypergeometricParameterFunction(r,omega,theta,sigma,rho);
	}
	
	public Model32(ParameterFunctionInterface parameters) {
